function [C,S,D] = AdaptiveDLAWithInitv7(x,v,k,C,S,D,t,updateDLA,tol,Awave,BC,FMWT)
...
elseif r < size(C,1) %Add most relavant vectors from residual
    ...
    [C1,S1,D1] = svds(@(x,trans) computeResidual(C,S,D,Awave,FF,x,trans,Chalf,Dhalf),[1,1]*size(C,1),10);
    ...
    [C,S,D] = AdaptiveDLAWithInitv7(x,v,k,C,S,D,t,updateDLA,tol,Awave,BC,FMWT);
    %[C,S,D] = updateDLA(C,S,D,t);
end
